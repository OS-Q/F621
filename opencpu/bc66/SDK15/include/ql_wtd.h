 ...
 * Attention:
 * ------------
 * When calling Ql_WTD_Init to start a GPTimer,it will affect the module to enter Deep Sleep mode.
 *
 *
 * Author:
 * -------
...
* Parameters:
*               resetMode:
*                    [in]0,H/W reset  reset,the customer need add a external watchdog chip.
*                         1,S/W reset.
*               wtdPin:
