...
*   Ql_SPI_Init(    1,                  //spi channel select.
                    PINNAME_PCM_IN,     //spi CLK pin, user could choose another pin.
                    PINNAME_PCM_SYNC,   //spi MISO pin, user could choose another pin.
                    PINNAME_PCM_OUT,    //spi MOSI pin, user could choose another pin.
                    PINNAME_PCM_CLK,    //User could choose another pin and init it, maintain the level by self.
                    0					//for S/W SPI.
                );                
*****************************************************************/
