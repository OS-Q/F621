...
* 
* Description:
*		This function reads the ADC value of specified ADC channel.
*
* Parameters:
* 		adcPin:
*			[in] support PIN_ADC0/PIN_ADC1/PIN_ADC2/PIN_ADC3.
* 		adc_vol:
*			[out] ADC value, The range is 0~1400mV.
*
*                 
* Return:        
...
#if 1  //Here is the loop interface,only supports ADC0
/*****************************************************************
...
* Parameters:
*               adcPin:
*                   ADC pin name, now only support PIN_ADC0.
*
*               callback_adc:
...
* Parameters:
*               adcPin:
*                   ADC pin name, only support PIN_ADC0.
*
*               count:
