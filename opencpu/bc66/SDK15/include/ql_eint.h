...
*               QL_RET_ERR_PINALREADYSUBCRIBE, the IO is in use in other place. 
*               For example this IO has been using as GPIO.
...
*               And the interrupt handler can not consume much CPU time,
*               or it may cause system exception or reset.
*
* Parameters:
*               eintPinName:
*                   EINT pin name, one value of Enum_PinName that has the interrupt function.
*               callback_eint:
*                   The interrupt handler, or ISR.
*
*               customParam:
...
*               QL_RET_ERR_PINALREADYSUBCRIBE, the pin is in use in other place. 
*               For example this pin has been using as GPIO.
