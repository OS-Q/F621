...
#define  SYS_CONFIG_APPVERSION_DATA_SIZE (50)
...
typedef enum{
    ...
    SYS_CONFIG_APP_VERSION_ID,		// For application version setting
...
typedef struct{
	u8 APP_VERSION[50];     //app version: maxinum support 50 bytes.
}ST_AppVerCfg;
