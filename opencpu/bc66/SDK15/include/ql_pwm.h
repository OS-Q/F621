...
* Parameters:
*               pinName:
*                   [in] Pin name, support three pwm channels, can PINNAME_NETLIGHT/PINNAME_RTS_AUX/PINNAME_GPIO3.
*               pwmSrcClk:
*                   [in] PWM source clock , one value of Enum_PwmSource.
*               pwmDiv:
*                   [in] source clock divide, one value of Enum_PwmSourceDiv
*               lowPulseNum:
*                   [in] set the number of clock cycles to stay at low level.
*					The result of lowPulseNum plus highPulseNum is less than 8193.
*               highPulseNum:
*                   [in] set the number of clock cycles to stay at high level. 
*					The result of lowPulseNum plus highPulseNum is less than 8193.
*
...
* Parameters:
*               pinName:
*                   Pin name, support three pwm channels(PINNAME_NETLIGHT/PINNAME_RTS_AUX/PINNAME_GPIO3) .
* Return:        
*               QL_RET_OK, this function succeeds.
*               QL_RET_ERR_NOSUPPORTPIN, the input pin is invalid. 
*****************************************************************/
