...
//WizIO - qapi_QT_Apps_AT_Port_Open(a, b, c, d)
#define qapi_QT_Apps_AT_Port_Open(a, b, c, d)	((UINT)(_txm_module_kernel_call_dispatcher)(TXM_OEM_API_AT_PORT_OPEN,(ULONG)a, (ULONG)b, (ULONG)c))
