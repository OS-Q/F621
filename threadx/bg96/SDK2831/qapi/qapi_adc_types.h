...
//#include "DDIAdc.h" //Hyman_20180102 comments because no this file.
...
//{Added by Quectel for ADC, start
/** Physical units are in millivolts. */
#define ADC_INPUT_ADC0           "MPP4_ADC0"

/** Physical units are in millivolts. */
#define ADC_INPUT_ADC1           "MPP6_ADC1"
//Added by Quectel for ADC, end}
...
typedef struct
{
   AdcResultStatusType eStatus;//unsigned int  eStatus;  /**< Status of the conversion. */modified by lane@20171128
