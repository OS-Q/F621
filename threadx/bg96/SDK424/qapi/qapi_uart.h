...
$Header: //components/rel/core.tx/1.0/buses/api/uart/qapi_uart.h#10 $

when         who     what, where, why
--------     ---     --------------------------------------------------------
10/25/2018   pr     Updated header file for QAPI_SET_POWER_SLEEP IOCTL.
...
typedef enum
{
  ...
  QAPI_SET_POWER_SLEEP        = 2,  /**< Put uart device in sleep mode */
